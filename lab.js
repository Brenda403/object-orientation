...
let jelly = new Cat("jelly", 2, "gray");
...
let wiz = new Wizard("Harry", 15, "Expelliarmus");
...
let phone1 = new Phone("apple", "14Pro", 156, "purple", 1699.99);
let phone2 = new Phone("samsung", "Galaxy S24+", 256, "purple", 1699.99);
let phone3 = new Phone("google", "Pixle XL", 156, "gray", 699.99);
...
//Code Here
let myFirstVehicle = new Vehicle("5", "blue", 100000);
...
class Motorcycle extends Vehicle {
  constructor(capacity, color, mileage, make, isCool) {
    ...
    (this.make = make), (this.isCool = isCool);
  }
}
...
let myFirstMotorcycle = new Motorcycle(1, "black", 0, "Honda", true);

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/

myFirstMotorcycle.move(8);
...
class Boat extends Vehicle {
  constructor(capacity, color, mileage, name, type, isSeaWorthy) {
    super(capacity, color, mileage);
    (this.name = name), (this.type = type), (this.isSeaWorthy = isSeaWorthy);
  }
  checkSeaWorthiness() {
...
let myFirstBoat = new Boat(5, "pink", 1000, "Embarco", "sailboat", false);
